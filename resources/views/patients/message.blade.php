...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        @foreach($messages as $message)
                <li class="clearfix">
                    <div class="message-data align-{{$message->GetSender() == $patient ? "right" : "left"}}">
                        <span class="message-data-time" >10:10 AM, Today</span> &nbsp; &nbsp;
                        <span class="message-data-name" >{{$message->GetSender()->first_name}}</span> <i class="fa fa-circle me"></i>

                    </div>
                    <div class="message {{$message->GetSender() == $patient ? "my" : "other"}}-message float-{{$message->GetSender() == $patient ? "right" : "left"}}">
                        {{$message->message}}
                    </div>
                </li>
        @endforeach
            ...
            <form method="POST">
                ...
                unset($part[array_search($patient,$inbox->GetInboxPartipicients())]);
