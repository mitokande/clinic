...
<head>
    ...
    <title>Doktor olarak Giriş Yap</title>
    @livewireStyles
    <!-- Favicons-->
...
<main>
		<div class="bg_color_2">
			<div class="container margin_60_35">
				<div id="login">
					<h1>DoktoraDanış' a Giriş Yapın!</h1>
					<div class="box_form">
					...
					<p class="text-center link_bright">Hesabınız yok mu? <a href="{{ route('doctor.register') }}"><strong>Şimdi Kayıt olun!</strong></a></p>
				</div>
				<!-- /login -->
			</div>
		</div>
